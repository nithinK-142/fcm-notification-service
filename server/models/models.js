...
const { TeamMemberModel } = require("./team-member.model.js");
const { RecipientModel } = require("./recipient.model.js");
...
async function initModels(LOCAL_DB, ATLAS_DB) {
    ...
    models = {
        ...
        TeamMember: TeamMemberModel(LOCAL_DB),
        Recipient: RecipientModel(ATLAS_DB),
    };
    return models;
}
